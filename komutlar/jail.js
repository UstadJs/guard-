...
if(!kanal) return message.channel.send(`Jail log kanalı ayarlı değil.`)
  ...
  if(!kişi) return message.channel.send(`Kimi Jail Vereceksin ? Etiketlemeyi unutma.`)
  if(kişi.hasPermission("ADMINISTRATOR")) return message.channel.send(`Olmaz. Bu kişiyi jail atamam.`)
